...
public class ExternalWalletPaymentStrategy implements PaymentStrategy {
    ...
    public PaymentResponseDTO pay(PaymentInitiateRequestDTO request) {
        ...
        return PaymentResponseDTO.builder()
                ...
                .message("External wallet payment successful")
                .build();
    }

    @Override
    public PaymentProviderType supports() {
        return PaymentProviderType.EXTERNAL_WALLET;
    }
}
